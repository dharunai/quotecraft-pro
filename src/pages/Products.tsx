                ...
                {filteredProducts.map((product) => (
                  <tr key={product.id} className={!product.is_active ? 'opacity-50' : ''}>
                    ...
                    <td className="font-medium">
                      {currency}{product.unit_price.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, tax_rate: e.target.value ? parseFloat(e.target.value) : null }))}
                    min="0"
                    max="100"
                    step="0.01"
